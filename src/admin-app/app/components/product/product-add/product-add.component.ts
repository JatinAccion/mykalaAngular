...
export class ProductAddComponent implements OnInit {
  ...
  getProfileInfoDropdowndata() {
    this.productService.getSellerTypes().subscribe(res => {
  ...
  getPaymentInfoDropdowndata() {
    this.productService.getPaymentMethods().subscribe(res => {
      this.paymentMethods = res;
    });
  }
  paymentMethodChange() {
    this.readPaymenInfo();
    this.productService.getPaymentVehicles().subscribe(res => {
