...
export const inputValidations = {
    ...
    'bankABARoutingNumber': { required: 'Please enter Routing Number', error: 'Please enter valid Routing Number' },
    'bankSwiftCode': { required: 'Please enter Swift Code', error: 'Please enter valid Swift Code' },
